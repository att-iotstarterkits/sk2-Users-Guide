...
// ****************************************************************************
// This main() example was copied from Chapter_03/c_03_system_info/main.cpp as
// a starting point for the gps_example.
// ****************************************************************************
int main(void) {
    gps_t       gps_value;                                                      // GPS info structure which is passed by reference to get_gps()
    int         ret;                                                            // Return variables from function calls
    json_keyval om[20];                                                         // JSON key/value pairs for MAL system info

// This code from here until "Start the GPS interface" example was copied
// from: Chapter_03/c_03_system_info example
