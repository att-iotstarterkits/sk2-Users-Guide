...
// Added Jan 2019
extern int do_http_put ( const char *, int, char **, const char * );
extern int do_http_post( const char *, int , char **, const char *, char * );
extern char *do_http_get ( const char *, int, char **, const char *, char *, int);
