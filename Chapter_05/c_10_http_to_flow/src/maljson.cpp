/* =====================================================================
   ...
   language governing permissions and limitations under the License.
    ...
    Changed        Size of 'expected tokens' to accomodate parsing larger M2X datasets
...
int parse_maljson(char *jstr, json_keyval rslts[], int s) {
    ...
    jsmn_parser p;
    jsmntok_t t[SZ]; /* We expect no more than 256 tokens */
    ...
    jsmn_init(&p);
    r = jsmn_parse(&p, jstr, strlen(jstr), t, SZ);
    if (r < 0) {
        return -1;
    }
