/* =====================================================================
   ...
   language governing permissions and limitations under the License.
    ...
    Modified       2019.01.21 (by Mindshare Advantage LLC for AT&T)
    Added          get_networkTime()
...
int stop_data_service(void) {

    int ret = 0;
    char jcmd1[] = "{\"action\":\"set_network_connection_mode\",\"args\":{\"mode\":1,\"ondemand_timeout\":0,\"manual_mode\":0}}";
    //char jcmd2[] = "{\"action\":\"set_wwan_allow_data_roaming\",\"args\":{\"enable\":1}}";
    ret  = send_mal_command(jcmd1, NULL, 0, false);
   // ret |= send_mal_command(jcmd2, NULL, 0, false);
...
char * get_networkTime(json_keyval *kv, int kvsize) {
    int  i, k;
    char rstr[500];
    char jcmd[] = "{ \"action\" : \"get_wwan_network_time\" }";
